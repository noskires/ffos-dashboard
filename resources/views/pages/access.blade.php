				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-toolbar">
							<div class="font-weight-bolder font-size-h1 text-dark-90 warning">91%</div>
						</div>
					</div>
					<!--end::Header-->
					<!--begin::Body-->
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-toolbar">
							<div class="font-weight-bolder font-size-h1 text-dark-200">12,033</div>
						</div>
					</div>
					<!--end::Header-->
					<!--begin::Body-->
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-toolbar">
							<div class="font-weight-bolder font-size-h1 text-dark-75">10,957</div>
						</div>
					</div>
					<!--end::Header-->
					<!--begin::Body-->
