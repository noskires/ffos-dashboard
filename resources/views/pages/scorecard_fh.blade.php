	...
	<div class="container">
        ...
        <div class="form-group row  d-flex flex-row-reverse">
			...
			<div class="col-lg-12" style="margin-top:-10;">
                DASHBOARD > NLFFOS > <b><u>SCORECARD (FH)</u> </b>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <!--begin::Chart-->
                        <div class="" apexcharts options="ScoreCardCtrl.overall_status_fh"></div>
                        <!--end::Chart-->
                    </div>
                </div>
                <!--end::Card-->
            ...
            <div class="col-lg-3">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <!--begin::Chart-->
                        <div class="" apexcharts options="ScoreCardCtrl.west_status_fh"></div>
                        <!--end::Chart-->
                    </div>
                </div>
                <!--end::Card-->
            ...
            <div class="col-lg-3">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <!--begin::Chart-->
                        <div class="" apexcharts options="ScoreCardCtrl.east_status_fh"></div>
                        <!--end::Chart-->
                    </div>
                </div>
                <!--end::Card-->
            ...
            <div class="col-lg-3">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <!--begin::Chart-->
                        <div class="" apexcharts options="ScoreCardCtrl.central_status_fh"></div>
                        <!--end::Chart-->
                    </div>
                </div>
                <!--end::Card-->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                        <h5 class="card-label">FH 2Q Scorecard per Field Force </h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin::Chart-->
                        <div class="" apexcharts options="ScoreCardCtrl.scorecard_fh"></div>
                        <!--end::Chart-->
                    </div>
                </div>
                <!--end::Card-->
