(function(){
    ...
    angular
        ...
        function SecondaryMttrCtrl(AccessTransportSrvcs, DivisionsSrvcs, FocSrvcs, $scope, $stateParams, $state, $uibModal, $window, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, SweetAlert){
            ...
            series: [{
                name: 'NL WEST',
                data: [1.1, 1.3, 1.1, 0.9, 0.9, 0.9, 0.8, 0.6]
              }, {
                name: 'NL EAST',
            ...
            vm.mttr_allin = {
                series: [
                    {
                    name: 'NL WEST',
                    data: [2.4, 2.5, 2.2, 1.9, 1.9, 1.8, 1.9, 1.5]
                  }, 
                  {
                    name: 'NL EAST',
                    data: [2.0, 1.9, 1.6, 1.5, 1.3, 1.6, 1.7, 1.3]
                  }, {
                    name: 'NL CENTRAL',
                    data: [2.9, 2.7, 2.0, 2.5, 2.6, 1.8, 1.9, 1.5]
                  }],
                    chart: {
                    height: 250,
                    type: 'area'
                ...
                vm.mttr_summary = {
                    series: [{
                        ...
                        name: 'ALL IN (DAY)',
                        data: [2.6, 2.5, 2.0, 2.2, 2.2, 1.8, 1.9, 1.5]
                      }],
                        chart: {
                        height: 250,
                        type: 'area'
