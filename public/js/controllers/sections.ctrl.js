(function(){
    ...
    angular
        ...
        SectionsCtrl.$inject = ['EmployeesSrvcs', 'DivisionsSrvcs', 'SectionsSrvcs', 'FocSrvcs', '$scope', '$stateParams', '$state', '$uibModal', '$window', '$rootScope', '$compile', 'DTOptionsBuilder', 'DTColumnBuilder', 'SweetAlert'];
        function SectionsCtrl(EmployeesSrvcs, DivisionsSrvcs, SectionsSrvcs , FocSrvcs, $scope, $stateParams, $state, $uibModal, $window, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, SweetAlert){
            var vm = this;
            var data = {};
            ...
            if($stateParams.section!=""){
                SectionsSrvcs.kpi({id:'', year:vm.year, division:$stateParams.division, section:$stateParams.section}).then (function (response) {
                ...
                SectionsSrvcs.topContributors({id:'', year:$stateParams.year, division:$stateParams.division, section:$stateParams.section}).then (function (response) {
                    if(response.data.status == 200){
            ...
            vm.select_section = function(year, division, section){
                ...
                if(section==""){
                    ...
                    SectionsSrvcs.kpi({id:'', year:$stateParams.year, division:$stateParams.division, section:section}).then (function (response) {
                        if(response.data.status == 200){
