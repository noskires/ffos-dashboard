(function(){
    ...
    angular
        ...
        function AccessCtrl(AccessTransportSrvcs, DivisionsSrvcs, FocSrvcs, $scope, $stateParams, $state, $uibModal, $window, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, SweetAlert){
            ...
            vm.co_access_value_target = [214,198,71,238,116,244,198,137];
            vm.co_access_value_actual = [208,182,68,232,115,216,194,135];
            vm.co_access_series = [];
            ...
            vm.npob_access_value_target = [97,47,20,106,44,99,156,43];
            vm.npob_access_value_actual = [86,36,19,99,27,77,111,27];
            ...
            vm.cs_access_value_target = [1675,1265,771,1275,826,1740,1763,690];
            vm.cs_access_value_actual = [1634,1018,727,1199,794,1563,1597,593];
            vm.cs_access_series = [];
