...
<head>
  ...
  <style type="text/css">
	...
	.orgchart .node .product-dept .title { background-color: #cc0066; }
  </style>
  <style>
	body{
    ...
    var ds = {
        ...
        children: [
            { 
				...
				'children': [
					{'name':'Mercado Jr., Carlos G. ', 'title': 'Head', 'className': 'rd-dept', avatar: "img/CGM.png",
						'children': [
							{'name':'Garvez, Anjela P.', 'title': 'Executive Secretary', 'className': 'frontend1', avatar: "img/APG.JPG",},
							{'name':'Agustin, Rajesh Khan D.', 'title': 'Team Head', 'className': 'frontend1', avatar: "img/RDA.png",
								'children': [
									{'name':'Angeles, Janver D.', 'title': 'Telecom Engineer', 'className': 'pipeline1', avatar: "img/JDA.png"},
									{'name':'Concepcion, Ryan Leandro N.', 'title': 'Telecom Engineer', 'className': 'pipeline1', avatar: "img/RNC.png"},
									{'name':'Dela Resma, Gian Carlo V.', 'title': 'Jr Telecom Engineer', 'className': 'pipeline1', avatar: "img/GVD.JPG"},
									{'name':'Supnet, Erikson B.', 'title': 'Telecom Engineer', 'className': 'pipeline1', avatar: "img/EBS.png"},
									{'name':'Urbano, Cleto B.', 'title': 'Telecom Engineer', 'className': 'pipeline1', avatar: "img/CBU.png"},
								]
							},
							{'name':'Simon, Maria Gretchen A.', 'title': 'Team Head', 'className': 'frontend1', avatar: "img/MAS.png",
								'children': [
									{'name':'Esguerra, Ryan Christian V.', 'title': 'Jr Telecom Engineer', 'className': 'pipeline1', avatar: "img/RVE.png"},
									{'name':'Manalo, Carlito D.', 'title': 'Telecom Associate', 'className': 'pipeline1', avatar: "img/CDM.png"},
									{'name':'Matias, John Austin S.', 'title': 'Jr Telecom Engineer', 'className': 'pipeline1', avatar: "img/JSM.png"},
									{'name':'Ramones, Aljhun C.', 'title': 'Jr Telecom Engineer', 'className': 'pipeline1', avatar: "img/ACR.JPEG"}
								]
							}
						]
					},
