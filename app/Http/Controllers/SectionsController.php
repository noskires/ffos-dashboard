...
class SectionsController extends Controller
{
    ...
    function get_net_ava_node($get_mttr_node, $get_mttr_foc, $year, $division, $section){
        ...
        if($year==2020){
            ...
            $ne_per_month   = array(3653, 3653, 3664, 3685, 3685, 3658, 3658, 3658, 3580, 3580, 3675, 3670);
            $ne_per_month_division = array(
            ...
            $ne_per_month_section = array(
                ...
                "NFS_WESTNL"=>array(
                    "NFS_WESTNL_FFS1"=>array(593,593,593,596,596,591,591,591,582,580,590,588),
                    "NFS_WESTNL_FFS2"=>array(371,371,378,381,381,372,372,372,355,352,356,356),
                    "NFS_WESTNL_FFS3"=>array(252,252,252,253,253,253,253,253,248,248,250,251)
                ),
                "NFS_EASTNL"=>array(
                    "NFS_EASTNL_FFS4"=>array(544,544,542,544,544,549,549,549,520,529,540,540),
                    "NFS_EASTNL_FFS5"=>array(320,320,323,323,323,328,328,328,337,335,348,347)
                ),
                "NFS_CENTRALNL"=>array(
                    "NFS_CENTRALNL_FFS6"=>array(484,484,482,482,482,480,480,480,476,481,480,476),
                    "NFS_CENTRALNL_FFS7"=>array(739,739,739,743,743,740,740,740,731,731,764,765),
                    "NFS_CENTRALNL_FFS8"=>array(350,350,355,363,363,345,345,345,331,343,347,347)
                )
            );

        }else{

            $ne_per_month   = array(3682, 3682, 3682, 3682, 3682, 3682, 3682, 3682, 3682, 3682, 3682, 3682);
            $ne_per_month_division = array(

                "NFS_WESTNL"=>array(1206,1206,1206,1206,1206,1206,1206,1206,1206,1206,1206,1206),
                "NFS_EASTNL"=>array(889,889,889,889,889,889,889,889,889,889,889,889),
                "NFS_CENTRALNL"=>array(1587,1587,1587,1587,1587,1587,1587,1587,1587,1587,1587,1587),
            ...
            $ne_per_month_section = array(
                ...
                "NFS_WESTNL"=>array(
                    "NFS_WESTNL_FFS1"=>array(598,598,598,598,598,598,598,598,598,598,598,598),
                    "NFS_WESTNL_FFS2"=>array(356,356,356,356,356,356,356,356,356,356,356,356),
                    "NFS_WESTNL_FFS3"=>array(252,252,252,252,252,252,252,252,252,252,252,252)
                ),
                "NFS_EASTNL"=>array(
                    "NFS_EASTNL_FFS4"=>array(543,543,543,543,543,543,543,543,543,543,543,543),
                    "NFS_EASTNL_FFS5"=>array(346,346,346,346,346,346,346,346,346,346,346,346)
                ),
                "NFS_CENTRALNL"=>array(
                    "NFS_CENTRALNL_FFS6"=>array(476,476,476,476,476,476,476,476,476,476,476,476),
                    "NFS_CENTRALNL_FFS7"=>array(765,765,765,765,765,765,765,765,765,765,765,765),
                    "NFS_CENTRALNL_FFS8"=>array(346,346,346,346,346,346,346,346,346,346,346,346)
                )
            );
