    ...
    function get_net_ava_node($get_mttr_node, $get_mttr_foc, $year, $division, $section){
        ...
        if($year==2020){
            ...
            $ne_per_month_section = array(
                ...
                "NFS_WESTNL"=>array(
                    "NFS_WESTNL_FFS1"=>array(593,593,593,596,596,591,591,591,582,582,582,582),
                    "NFS_WESTNL_FFS2"=>array(371,371,378,381,381,372,372,372,355,355,355,355),
                    "NFS_WESTNL_FFS3"=>array(252,252,252,253,253,253,253,253,248,248,248,248)
                ),
                "NFS_EASTNL"=>array(
                    "NFS_EASTNL_FFS4"=>array(544,544,542,544,544,549,549,549,520,520,520,520),
                    "NFS_EASTNL_FFS5"=>array(320,320,323,323,323,328,328,328,337,337,337,337)
                ),
                "NFS_CENTRALNL"=>array(
                    "NFS_CENTRALNL_FFS6"=>array(484,484,482,482,482,480,480,480,476,476,476,476),
                    "NFS_CENTRALNL_FFS7"=>array(739,739,739,743,743,740,740,740,731,731,731,731),
                    "NFS_CENTRALNL_FFS8"=>array(350,350,355,363,363,345,345,345,331,331,331,331)
                )
            );
