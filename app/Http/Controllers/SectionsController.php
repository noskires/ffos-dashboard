...
class SectionsController extends Controller
{
    ...
    function get_net_ava_node($get_mttr_node, $get_mttr_foc, $year, $division, $section){
        ...
        if($year==2020){
            ...
            $ne_per_month_division = array(
                "NFS_WESTNL"=>array(1216,1216,1223,1230,1230,1216,1216,1216,1216,1216,1216,1216),
                "NFS_EASTNL"=>array(864,864,865,867,867,877,877,877,877,877,877,877),
                "NFS_CENTRALNL"=>array(1573,1573,1576,1588,1588,1565,1565,1565,1565,1565,1565,1565),
            );

            $ne_per_month_section = array(

                "NFS_WESTNL"=>array(
                    "NFS_WESTNL_FFS1"=>array(593,593,593,596,596,591,591,591,591,591,591,591),
                    "NFS_WESTNL_FFS2"=>array(371,371,378,381,381,372,372,372,372,372,372,372),
                    "NFS_WESTNL_FFS3"=>array(252,252,252,253,253,253,253,253,253,253,253,253)
                ),
                "NFS_EASTNL"=>array(
                    "NFS_EASTNL_FFS4"=>array(544,544,542,544,544,549,549,549,549,549,549,549),
                    "NFS_EASTNL_FFS5"=>array(320,320,323,323,323,328,328,328,328,328,328,328)
                ),
                "NFS_CENTRALNL"=>array(
                    "NFS_CENTRALNL_FFS6"=>array(484,484,482,482,482,480,480,480,480,480,480,480),
                    "NFS_CENTRALNL_FFS7"=>array(739,739,739,743,743,740,740,740,740,740,740,740),
                    "NFS_CENTRALNL_FFS8"=>array(350,350,355,363,363,345,345,345,345,345,345,345)
                )
            );
